...
<template>
  ...
  <AuthenticatedLayout>
    ...
    <div class="flex-1 flex flex-col h-full overflow-hidden max-w-screen-xl mx-auto px-4">
      <div class="flex-1 h-full overflow-x-auto">
        <div class="inline-flex h-full items-start p-4 space-x-4 overflow-hidden">
          <Column
